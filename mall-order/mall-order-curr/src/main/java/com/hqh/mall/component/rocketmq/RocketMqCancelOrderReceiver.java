...
@Slf4j
@Component
@RocketMQMessageListener(consumerGroup = "CancelOrderGroup",topic = "${rocketmq.mall.asyncOrderTopic}")
public class RocketMqCancelOrderReceiver implements RocketMQListener<String> {
    @Autowired
