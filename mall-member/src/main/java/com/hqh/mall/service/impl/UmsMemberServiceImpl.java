...
import com.hqh.mall.common.api.TokenInfo;
import com.hqh.mall.constant.MemberConstant;
import com.hqh.mall.mapper.UmsMemberLevelMapper;
...
import com.hqh.mall.model.UmsMemberLevelExample;
import com.hqh.mall.service.RedisService;
import com.hqh.mall.service.UmsMemberService;
...
/*    @Override
    ...
    public TokenInfo login(String username, String password) {
        ...
        try{
            ...
            response = restTemplate.exchange(MemberConstant.OAUTH_LOGIN_URL, HttpMethod.POST, wrapOauthTokenRequest(username,password), TokenInfo.class);
    ...
    private HttpEntity<MultiValueMap<String, String>> wrapOauthTokenRequest(String userName, String password) {
        ...
        reqParams.add( MemberConstant.USER_NAME,userName);
        reqParams.add( MemberConstant.PASS,password);
        reqParams.add( MemberConstant.GRANT_TYPE, MemberConstant.PASS);
        reqParams.add( MemberConstant.SCOPE, MemberConstant.SCOPE_AUTH);
    ...
    private HttpHeaders wrapHttpHeaders() {
        ...
        httpHeaders.setBasicAuth( MemberConstant.CLIENT_ID, MemberConstant.CLIENT_SECRET);
        return httpHeaders;
    }
    ...
    public String refreshToken(String token) {
        ...
        try{
            ...
            //刷新令牌
            responseEntity = restTemplate.exchange( MemberConstant.OAUTH_LOGIN_URL, HttpMethod.POST, wrapRefreshTokenRequest(jwtTokenValue), TokenInfo.class);
