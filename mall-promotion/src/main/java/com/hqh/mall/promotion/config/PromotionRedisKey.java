...
public class PromotionRedisKey {
    ...
    public String getPromotionNamespace() {
        return promotionNamespace;
    }
    ...
    public String getDlBrand() {
        return dlBrand;
    }

    public String getDlNewProduct() {
        return dlNewProduct;
    }

    public String getDlRecProduct() {
        return dlRecProduct;
    }

    public String getDlHomeAdvertise() {
        return dlHomeAdvertise;
    }
